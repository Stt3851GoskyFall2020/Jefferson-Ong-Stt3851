...
* Here we changed status of the house into a factor of three levels where sld = 1, meaning 1 when the house is sold, pen = 2 where the house is pending sale, and act = 3 where house is in the active listing. We did the same for the elementary school district
...
* We can be 95% confident that the actual mean price value for elem2 is between -$147.1K to -$29.3K.

* We can be 95% confident that the actual mean price value for elem3 is between -$126.0K to -$54.1K.

* We can be 95% confident that the actual mean price value for elem4 is between -$110.2K to -$46.9K.

* We can be 95% confident that the actual mean price value for elem5 is between -$76.1K  to -$2.4K.

* We can be 95% confident that the actual mean price value for elem6 is between -$127.4K to -$27.4K.

* We can be 95% confident that the actual mean price value for status2 is between  $2.6K to $62.5K.

* We can be 95% confident that the actual mean price value for status3 is between $19.4K to $72.0K.

* We can be 95% confident that the actual mean price value for size is between $15.2K to $141.2K.
...
* $225.8K is the point estimate for this particular house
* Based on the model centered around the mean prediction values, we can be 95% confident the true mean home price is between $199.6K to $251.9K
...
* $225.8K is the point estimate for future houses
* Based on the model centered around the point estimate, we expect a future home built to have a price of $133.6K to $317.9K 95% of the time and 5% of the time to have a price outside this range.
