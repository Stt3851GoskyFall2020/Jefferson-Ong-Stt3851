...
* We can be 95% confident that the actual mean value for elem2 is between -147.083452 to -29.326497.

* We can be 95% confident that the actual mean value for elem3 is between -125.974296 to -54.054080.

* We can be 95% confident that the actual mean value for elem4 is between -110.188716 to -46.906813.

* We can be 95% confident that the actual mean value for elem5 is between -76.117722  to -2.368995.

* We can be 95% confident that the actual mean value for elem6 is between -127.375332 to -27.352433.

* We can be 95% confident that the actual mean value for status2 is between  2.627647 to 62.494973.

* We can be 95% confident that the actual mean value for status3 is between 19.442006 to 71.999903.

* We can be 95% confident that the actual mean value for size is between 15.759564 to 141.087464.

* We can be 95% confident that the actual mean value for bedrooms is between -35.326602 to -4.198871.
...
* Based on the model centered around the mean prediction values, we can be 95% confident a house with these predictors will have a price of 199.6205 to 251.8815
...
* 225.751 is the point estimate for this particular house
* Based on the model centered around the point estimate, 95% of houses with these predictors will have a price of 133.5833 to 317.9188
